...
const CancelStatus = () => {
  ...
  const pdfDownloadinvoice = e => {
    // console.log("invoice")
    e.preventDefault()
    let doc = new jsPDF("landscape", 'pt', 'A4');
    doc.html(document.getElementById('pdf-views'), {
      callback: () => {
  ...
  const pdfDownloadcreditnotes = e => {
    e.preventDefault()
    let doc = new jsPDF("landscape", 'pt', 'A4');
    doc.html(document.getElementById('pdf-view-credit-notes'), {
      callback: () => {
        doc.save('Invoice.pdf');
      }
    });
          ...
          <div className="row p-2">
            ...
            <div className="col-md-4 pt-3">
              ...
              <select value={odstatus} className=" btn hoveffz d-md-inline" style={{ backgroundColor: "#fc8181", color: "#fff", width: "154px" }}
                ...
                {/* <option className="dropdown_list" value="New orders" style={{ backgroundColor: "white", color: "red" }}>Refund</option>
                <option className="dropdown_list" value="Preparing" style={{ backgroundColor: "white", color: "red" }}>Intransit</option>
                <option className="dropdown_list" value="Ready to Handovereli" style={{ backgroundColor: "white", color: "red" }}>Rejected</option> */}
                ...
                <div className="shipdea">
                  ...
                  <div className="row d-flex justify-content-between mb-2">
                    ...
                    <div className="col-md-6 text-right">
                      <Button size="sm" className="btn-dim" color="dark" style={{ fontSize: "9px" }} onClick={pdfDownloadinvoice} >Download Invoice &nbsp;<Icon name="arrow-to-down"></Icon></Button><br></br>
                      <Button size="sm" className="btn-dim mt-2 font-weight-bold" color="dark" style={{ fontSize: "9px" }} onClick={pdfDownloadcreditnotes} >Download CreditNotes &nbsp;<Icon name="arrow-to-down"></Icon></Button>
                    </div>
