          ...
          <div className="container-fluid">
            ...
            <div className="row">
              ...
              <div className="col-md-12 p-3 alert alert-secondary border-0 d-flex">
                ...
                <h6>Order Date: <b>28-12-2022</b></h6>
              </div>
          ...
          <div className="row p-2">
            ...
            <div className="col-md-4 pt-3">
              ...
              <select value={odstatus} className=" btn hoveffz d-md-inline" style={{ backgroundColor: "#fc8181", color: "#fff" }}
                ...
                <option className="dropdown_list" value="New orders" style={{ backgroundColor: "white", color: "red" }}>Return requested</option>
                <option className="dropdown_list" value="Preparing" style={{ backgroundColor: "white", color: "red" }}>Return initiated</option>
                <option className="dropdown_list" value="Ready to Handovereli" style={{ backgroundColor: "white", color: "red" }}>Pending QC</option>
                <option className="dropdown_list" value="Ready to Handovereli" style={{ backgroundColor: "white", color: "red" }}>Returned</option>
...
export default ReturnSubOrderStatus;
