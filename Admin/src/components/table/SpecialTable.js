    ...
    <table className="table table-ulogs">
      <thead className="thead-light">
        <tr>
          ...
          <th className="tb-col-ht">
            <span className="overline-title">Hits</span>
          </th>
          <th className="tb-col-pv">
            <span className="overline-title">Page Views</span>
          </th>
          <th className="tb-col-time">
            <span className="overline-title"> Last  Visit</span>
          </th>
        ...
        {loginData.map((item, idx) => {
          return (
            <tr key={idx}>
              ...
              <td className="tb-col-ip">
                <span className="sub-text">{item.ht}</span>
              </td>
              <td className="tb-col-ip">
                <span className="sub-text">{item.pv}</span>
              </td>
