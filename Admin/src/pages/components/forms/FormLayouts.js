...
const FormLayoutsPage = ({ ...props }) => {
 ...
 onmousewheel="return false;" onWheelCapture={e => {
  e.target.blur()
}} id="pay-amount" className="form-control" />
                    </div>
                  </FormGroup>
                  <FormGroup className="form-group">
 ...
 onmousewheel="return false;" onWheelCapture={e => {
  e.target.blur()
}} id="cf-phone-no" className="form-control" />
                  </FormGroup>
                  <FormGroup className="form-group">
 ...
 onmousewheel="return false;" onWheelCapture={e => {
  e.target.blur()
}} id="phone-no-1" className="form-control" />
                    </div>
                  </FormGroup>
                </Col>
                <Col lg="6">
 ...
 onmousewheel="return false;" onWheelCapture={e => {
  e.target.blur()
}} id="pay-amount-1" className="form-control" />
                    </div>
                  </FormGroup>
                </Col>
                <Col lg="6">
            ...
            <form className="gy-3">
              ...
              <Row className="g-3 align-center">
                ...
                <Col lg="7">
                  <FormGroup>
                    <div className="form-control-wrap">
                      <input type="text" id="site-email" className="form-control" defaultValue="info@babyamore.in" />
                    </div>
                  </FormGroup>
                </Col>
              </Row>
                  ...
                  <FormGroup>
                    <div className="form-control-wrap">
                      <input
                        ...
                        name="site-url"
                        className="form-control"
                        defaultValue="https://www.babyamore.in"
                      />
                    </div>
                  </FormGroup>
                </Col>
