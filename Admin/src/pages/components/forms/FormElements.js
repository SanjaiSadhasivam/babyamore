    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Pormotions controls</BlockTitle>
              <p>
              The pormotional tagline will be placed on the main navigation.
              ...
              <Col sm="6">
                <FormGroup>
                  ...
                  <input
                    ...
                    disabled
                    defaultValue="info@babyamore.in"
