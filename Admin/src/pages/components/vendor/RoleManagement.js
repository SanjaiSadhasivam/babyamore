...
const idven = localStorage.getItem("MerchantView");
const Roles = () => {
  ...
  const GetRole = async (id) => {
    const data = await axios.get(`${Role_Api}/?vendor_id=${id}`, { headers: { Authorization: `Bearer ${token} ` } });
  ...
  const EditTable = async (data, type) => {
    ...
    // console.log("sdsdssdsds", role_name)
    // console.log("sdsdssdsds", permiss)
    setUser({
      role_name: role_name,
    });
    setProductCheck({
                      ...
                      <Col md="4">
                        <div className="custom-control custom-checkbox mx-5 mb-1">
                          <input
                            ...
                            checked={ProductCheck.View} onChange={attributeChange("View")}
                            id="customCheck1"
                          />
                      ...
                      <Col md="4">
                        <div className="custom-control custom-checkbox mx-5 mb-1">
                          <input
                            ...
                            className="custom-control-input form-control"
                            name="categorydelete"
                            checked={ProductCheck.Delete} onChange={attributeChange("Delete")}
                            id="customCheck2"
                          />
                      ...
                      <Col md="4">
                        <div className="custom-control custom-checkbox mx-5 mb-1">
                          <input
                            ...
                            checked={DisputeCheck.View} onChange={attributeChange1("View")}
                          />
                      ...
                      <Col md="4">
                        <div className="custom-control custom-checkbox mx-5 mb-1">
                          <input
                            ...
                            id="customCheck25"
                            name="productview"
                            checked={MessageCheck.View} onChange={attributeChange2("View")}
                          />
