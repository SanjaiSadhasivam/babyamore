...
const Company = ({ alter, id }) => {
  ...
  const Foodproduct = () => setFoodstate(false);
  ...
  const Getdata = async (ids) => {
    ...
    if (datas) {
      ...
      setFoodstate(is_selling_food==1?true:false )
    }
  };
  ...
  const Create = async () => {
    ...
    try {
      ...
      const Result = await axios.put(`${API_Vendor}/${ids}`, formData, config);
      if (Result) {
        Getdata(ids);
        setToggle(true);
                                                ...
                                                if (file.image) {
                                                  ...
                                                  return (
                                                    <div className="dz-message">
                                                      <span className="dz-message-text">Drag & Drop a File</span>
                                                      <span className="dz-message-or">or</span>
                                                      <Button color="primary" disabled={toggle}>
                                                        Upload
                                                      </Button>
                                                    </div>
                                                  );
