...
export const dataTableColumns = [
  ...
  },
  {
    ...
    cell: (row) => (
      <>
        <DropdownItem tag="a" href="#dropdown" className="p-0" style={iconstyle}>
          <Icon name="edit"></Icon>
        </DropdownItem>
        <DropdownItem tag="a" href="#dropdown" className="p-0" style={iconstyle}>
          <Icon name="eye"></Icon>
...
const disputesTableColumnchild = [
  {
    field: "Image",
    title: "Image",
...
export const CouponCodeData = [
  {
    CouponName: "BabyAmore",
    OfferPrice: "10%",
    Status: "Active",
  ...
  },
  {
    ...
    OfferPrice: "₹ 250",
    Status: "Active",
    StartDate: "Jun 3, 2022",
    EndDate: "Jul 1, 2022",
  },
  {
    CouponName: "FIRSTSALE",
    OfferPrice: "₹ 300",
    Status: "Active",
...
export const DisputesTableData = [
  {
    Name: "Allter Prints",
    Slug: "allter-prints",
    Terms: "Babyexplorer, Babyfeet",
  },
  {
    Name: "Allter Sizes",
    Slug: "allter-sizes",
    Terms: "NewBorn, Small, Medium, Large, X-Large",
  },
  {
    Name: "Avanchy Colors",
    Slug: "avanchy-colors",
    Terms: "Black, Blue, Gray, Green, Magenta, Orange, Pink, White, Yellow",
  },
  {
    Name: "Bambo Nature",
    Slug: "bambo-nature",
...
export const DisputesTableData11 = [
  ...
  },
  {
    ...
    GrandTotal: "₹1200",
    MobileNo: "9876543210",
    Address: "Anna Nagar, Chennai, Tamil Nadu 600028",
  },
  {
    CustomerName: "Das",
    Items: "Hair Care",
    ...
    GrandTotal: "₹2100",
    MobileNo: "9876543210",
    Address: "Nungambakkam, Chennai, Tamil Nadu 600028",
  },
  {
    CustomerName: "Vikram",
    Items: "Diapers",
    ...
    GrandTotal: "₹2400",
    MobileNo: "9677123456",
    Address: "T Nagar, Chennai, Tamil Nadu 600028",
  },
];

export const DisputesTableCancelData = [
  {
    OrderID: "OD-001",
  ...
  //   Customer: "Das",
  //   Total: "₹1500",
  //   Address: "Nunngambakkam, Chennai, Tamil Nadu 600028",
  //   Status: "Cancelled"
  // },
  // {
  //   OrderID: "OD-1001",
...
export const DisputesTableCancelData1 = [
  {
    OrderID: "OD-001",
    SubOrderID: "OD_001_001",
    Vendor: "navin",
...
export const DisputesTableData102 = [
  {
    id: 45678,
    UserIcon: User,
    StaffName: "Michael Jack",
    RoleName: "Admin",
    PhoneNumber: "9876543210",
    Email: "micheal@babayamore.in",
    Country: "India",
    Role: "Admin",
    Status: "Active",
  },
...
//productlist
export const ProductCodeColumnsData = [
  {
    id: 45678,
    Image: "",
    ProductId: "PROD-0004",
...
//customer
export const DisputesTableDatacustomer = [
  {
    UserIcon: User,
    UserName: "Rolex",
    PhoneNumber: "9876543210",
    Email: "rolex@babayamore.in",
    Country: "India",
    Role: "Admin",
  },
  {
...
export const DisputesTableDatachild = [
  {
    Image: Diapers,
    CategoryName: "Nappy Care",
    SubCategory: "Diapers & Pants",
    ChildCategory: "Training Pants",
    Slug: "training-pants",
    Meta: "Training Pants",
  },
  {
    ...
    CategoryName: "Feeding",
    SubCategory: "Bottle Feeding",
    ChildCategory: "Feeding Bottles",
    Slug: "feeding-bottles",
    Meta: "Feeding Bottles",
  },
  {
    Image: OralHealth,
    CategoryName: "Oral Care",
    SubCategory: "Oral Care",
    ChildCategory: "Toothbrush",
    Slug: "Toothbrush",
    Meta: "Toothbrush",
  },
];
...
export const DisputesTableDatabanner = [
  {
    no: 1,
    id: 1,
    name: "http://localhost:3006/dashboard/banners",
    name1: "Image Position 2",
    name2: "Admin",
    age: "Baby Product",
    gender: "Apr 26, 2022",
    image: User2,
...
export const DisputesTableData1102 = [
  ...
  },
  {
    Image: User,
    Name: "Rolex",
    Email: "rolcex@gmail.com",
    PhoneNumber: "9877662341",
    Orders: "15",
  },
];
// --------------------------------------------------
