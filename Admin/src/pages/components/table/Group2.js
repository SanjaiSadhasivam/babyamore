...
import { DisputesTableData102Gro2, disputesTableColumnsadd2sGro2, disputesTableColumns2s1, userData } from "./TablesData";
...
const onFormSubmit = (form) => {
  ...
  return (
    <React.Fragment>
      <Head title="CATEGORY SUB-GROUPS" />
      <Content page="component">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h4">CATEGORY SUB-GROUPS</BlockTitle>
              {/* <p>
                ...
                >
                  <ul className="nk-block-tools g-3" style={{ justifyContent: "end" }}>
                    <li className="nk-block-tools-opt">
                      ...
                      >
                        <Icon name="plus"></Icon>
                        <span>ADD CATEGORY SUB-GROUPS </span>
                      </Button>
                    </li>
                    {/* <li className="nk-block-tools-opt">
                      <Button
          ...
          <PreviewCard>
            <ReactDataTable
              data={DisputesTableData102Gro2}
              columns={disputesTableColumnsadd2sGro2}
              expandableRows
              pagination
              actions
            />
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <input
                            ...
                            placeholder="Category Sub-Group "
                          />
                        </div>
                      </div>
                      </Col>
                          ...
                          <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                            {({ getRootProps, getInputProps }) => (
                              <section>
                                ...
                                >
                                  <input {...getInputProps()} />
                                  {files1.length === 0 && <p>Categories Cover Image</p>}
                                  {files1.map((file) => (
                                    <div
                                      key={file.name}
