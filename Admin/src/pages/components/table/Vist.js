...
import { DisputesTableDataVist, disputesTableColumnsvist, disputesTableColumns2s1, userData } from "./TablesData";
    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h4">VISITORS</BlockTitle>
          ...
          <PreviewCard>
            <ReactDataTable
              data={DisputesTableDataVist}
              columns={disputesTableColumnsvist}
              expandableRows
              pagination
              actions
            />
