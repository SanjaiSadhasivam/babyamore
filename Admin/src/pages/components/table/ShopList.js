...
import { DisputesTableData11021ss, disputesTableColumnsadd2s12s22, disputesTableColumns2s1, userData } from "./TablesData";
    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h4"> SHOP </BlockTitle>
              {/* <p>
          ...
          <PreviewCard>
            <ReactDataTable
              data={DisputesTableData11021ss}
              columns={disputesTableColumnsadd2s12s22}
              expandableRows
              pagination
              actions
            />
