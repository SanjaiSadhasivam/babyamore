    ...
    try {
      axios
        ...
        .catch(function (error) {
          ...
          console.log(error.response.data.msg); // this is the part you need that catches 400 request
        });
    } catch (error) {
