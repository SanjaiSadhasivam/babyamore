...
export const BusinessAreaPage = () => {
  ...
  return (
    <React.Fragment>
      <Head title="Business Area"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page> Countries  </BlockTitle>
          ...
          <div className="nk-tb-list is-separate nk-tb-ulist">
            <DataTableHead className="nk-tb-item nk-tb-head">
              ...
              <DataTableRow size="lg">
                <span className="sub-text"> ISO Code</span>
              </DataTableRow>
              <DataTableRow>
                <span className="sub-text">Country Name</span>
              </DataTableRow>
              ...
              <DataTableRow size="md">
                <span className="sub-text"> No of Regions </span>
              </DataTableRow>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add Countries</h5>
              <div className="mt-4">
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        className="form-control"
                        ref={register({
                          required: "Enter the Citizenship Code",
                        })}
                      />
                      {errors.title && <span className="invalid">{errors.title.message}</span>}
                    </FormGroup>
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        type="text"
                        name="title"
                        defaultValue={formData.title7}
                        placeholder="ENTER THE ISO CODE "
                        onChange={(e) => onInputChange(e)}
                        className="form-control"
                        ref={register({
                          required: "Enter the Capital",
                        })}
                      />
                      {errors.title && <span className="invalid">{errors.title.message}</span>}
                    </FormGroup>
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="status"
                            options={[
                              { value: "On Holdfffd", label:  "Greenwich Meridian" },
                              { value: "Delivered", label: " Newfoundland and Labrador " },
                            ]}
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="status"
                            options={[
                              { value: "On Hold", label: "Albania Lek" },
                              { value: "Delivered", label: "Argentina Peso" },
                              { value: "Delivered", label: "India" },
                              { value: "Delivered", label: "Aruba Guilder" },
                            ]}
                            onChange={(e) => setFormData({ ...formData, status: e.value })}
                            defaultValue={formData.status}
                          />
