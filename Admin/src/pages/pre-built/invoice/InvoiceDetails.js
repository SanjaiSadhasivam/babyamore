        ...
        <Content>
          <BlockHead>
            <BlockBetween className="g-3">
              <BlockHeadContent>
                <BlockTitle>
                   Refund ID <strong className="text-primary small">#{user.orderId}</strong>
                </BlockTitle>
              ...
              <div className="invoice-wrap">
                ...
                <div className="invoice-head">
                  <div className="invoice-contact">
                    <span className="overline-title">Refund To</span>
                  ...
                  <div className="invoice-desc">
                    <h3 className="title">Refund  </h3>
                    <ul className="list-plain">
                      <li className="invoice-id">
                        <span> Refund ID</span>:<span>{user.orderId}</span>
                      </li>
                ...
                <div className="invoice-bills">
                  <div className="table-responsive">
                    ...
                    <div className="nk-notes ff-italic fs-12px text-soft">
                      Refund ID was created on a computer and is valid without the signature and seal.
                    </div>
                  </div>
                </div>
              </div>
