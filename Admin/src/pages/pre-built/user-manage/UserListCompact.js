...
import { merchData, filterRole, filterStatus } from "./UserData";
import {
  DropdownMenu,
  DropdownToggle,
  FormGroup,
...
const UserListCompact = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = merchData.filter((item) => {
        return (
      ...
      <Content>
          ...
          <DataTable className="card-stretch">
            ...
            <DataTableBody compact>
              <DataTableHead>
                ...
                <DataTableRow>
                  <span className="sub-text">Avator</span>
                </DataTableRow>
                <DataTableRow size="md">
                  <span className="sub-text"> Nice Name </span>
                </DataTableRow>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">ADD MERCHANT </h5>
              <div className="mt-4">
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Merchant </h5>
              <div className="mt-4">
