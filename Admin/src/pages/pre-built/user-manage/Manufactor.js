...
import { filterStatus, manufactData } from "./GroupData";
...
const ManufactorPage = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = manufactData.filter((item) => {
        return (
      ...
      <Content>
          ...
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow size="mb">
                <span className="sub-text">Order Value</span>
              </DataTableRow>
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add Manufacturers</h5>
              <div className="mt-4">
                      ...
                      <Dropzone onDrop={(acceptedFiles) => handleDropChange(acceptedFiles)}>
                        {({ getRootProps, getInputProps }) => (
                          <section>
                            ...
                            >
                              <input {...getInputProps()} />
                              {files.length === 0 && <p>Drop some files here(Logo image size should be minimum 300x300px)</p>}
                              {files.map((file) => (
                                <div
                                  key={file.name}
                      ...
                      <Dropzone onDrop={(acceptedFiles) => handleDropChange2(acceptedFiles)}>
                        {({ getRootProps, getInputProps }) => (
                          <section>
                            ...
                            >
                              <input {...getInputProps()} />
                              {files2.length === 0 && <p>Drop some files here(Featured image size should be 380x160px)</p>}
                              {files2.map((file) => (
                                <div
                                  key={file.name}
                                  className="dz-preview dz-processing dz-image-preview dz-error dz-complete"
