...
import { filterRole, listsData, filterStatus } from "./UserData";
...
const UserListRegularPage = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = listsData.filter((item) => {
        return (
                          ...
                          <ul className="nk-tb-actions gx-1">
                            <li className="nk-tb-action-hidden" onClick={() => onEditClick(item.id)}>
                              <TooltipComponent
                                ...
                                text="Edit"
                              />
                            </li><li className="nk-tb-action-hidden" onClick={() => onEditClick(item.id)}>
                              <TooltipComponent
                                tag="a"
                                containerClassName="btn btn-trigger btn-icon"
                                id={"view" + item.id}
                  ...
                  {/* <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        name="balance"
                        disabled
                        defaultValue={parseFloat(formData.phone.replace(/,/g, ""))}
                        placeholder="Balance"
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.phone && <span className="invalid">{errors.phone.message}</span>}
