...
import { filterStatus, langData } from "./UserData";
...
const LanguagesPage = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = langData.filter((item) => {
        return (
      ...
      <Content>
          ...
          <BlockBetween>
            <BlockHeadContent>
              ...
              <BlockDes className="text-soft">
                <p>You have total 295 Languages.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
        ...
        <Block>
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow size="lg">
                <span className="sub-text">php Local Code</span>
              </DataTableRow>
              {/* <DataTableRow size="md">
        ...
        <Modal isOpen={modal.add} toggle={() => setModal({ add: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add Languages</h5>
              <div className="mt-4">
                <Form className="row gy-4" noValidate onSubmit={handleSubmit(onFormSubmit)}>
                  ...
                  <Col md="6">
                    <FormGroup>
                      <label className="form-label"> php local code</label>
                      <input
                        className="form-control"
                        type="number"
                        name="balance"
                        defaultValue={formData.balance}
                        placeholder="PHP Local Code"
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.balance && <span className="invalid">{errors.balance.message}</span>}
                    </FormGroup>
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="status"
                            options={[
                              { value: "On Holdfffd", label:  "RTL Yes" },
                              { value: "Delivered", label: "RTL No " },
                            ]}
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="status"
                            options={[
                              { value: "On Holdfffd", label:  "Active" },
                              { value: "Delivered", label: " In Active " },
                            ]}
                            onChange={(e) => setFormData({ ...formData, status: e.value })}
                            defaultValue={formData.status}
                          />
        ...
        <Modal isOpen={modal.edit} toggle={() => setModal({ edit: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Language User</h5>
              <div className="mt-4">
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        name="balance"
                        disabled
                        defaultValue={parseFloat(formData.lastLogin.replace(/,/g, ""))}
                        placeholder="Ordered"
                        ref={register({ required: "This field is required" })}
                      />
        ...
        <Modal isOpen={modal.view} toggle={() => setModal({ view: false })} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title"> User Language Details</h5>
              <div className="mt-4">
                <Form className="row gy-4" onSubmit={handleSubmit(onEditSubmit)}>
                  <Col md="6">
                    <FormGroup>
