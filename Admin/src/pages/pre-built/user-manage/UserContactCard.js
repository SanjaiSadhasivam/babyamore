...
const UserContactCardPage = () => {
  ...
  return (
    <React.Fragment>
      <Head title="User Roles"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>User's Roles</BlockTitle>
              <BlockDes className="text-soft">
                <p>You have total 25 users.</p>
              </BlockDes>
            </BlockHeadContent>
            <BlockHeadContent>
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="status"
                            options={[
                              { value: "On Hold", label: "Platfrom" },
                              { value: "Delivered", label: "Merchant" },
                       ...
                       ATTRIBUTES 
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="status"
                            options={[
                              { value: "On Hold", label: "VIEW" },
                              { value: "Delivered", label: "ADD" },
                              { value: "Delivered", label: "EDIT" },
                              { value: "Delivered", label: "DELETE" },
                            ]}
                          />
                        </div>
                      </div>
