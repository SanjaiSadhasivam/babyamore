...
import { filterStatus, catData } from "./UserData";
...
const CategoriesPage = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = catData.filter((item) => {
        return (
        ...
        <Block>
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow>
                <span className="sub-text">Cover Image</span>
              </DataTableRow>
              <DataTableRow>
                <span className="sub-text">Featured Image</span>
              </DataTableRow>
              ...
              <DataTableRow size="lg">
                <span className="sub-text">Attributes</span>
              </DataTableRow>
              <DataTableRow size="lg">
                      ...
                      <Dropzone onDrop={(acceptedFiles) => handleDropChange(acceptedFiles)}>
                        {({ getRootProps, getInputProps }) => (
                          <section>
                            ...
                            >
                              <input {...getInputProps()} />
                              {files.length === 0 && <p>Drop some files here(Cover image size should be 1280x300px)</p>}
                              {files.map((file) => (
                                <div
                                  key={file.name}
                      ...
                      <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                        {({ getRootProps, getInputProps }) => (
                          <section>
                            ...
                            >
                              <input {...getInputProps()} />
                              {files1.length === 0 && <p>Drop some files here(Featured image size should be 285x190px)</p>}
                              {files1.map((file) => (
                                <div
                                  key={file.name}
                                  className="dz-preview dz-processing dz-image-preview dz-error dz-complete"
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.odd && <span className="invalid">{errors.odd.message}</span>}
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        name="balance"
                        disabled
                        defaultValue={parseFloat(formData.country)}
                        placeholder="Ordered"
                        ref={register({ required: "This field is required" })}
                      />
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        name="balance"
                        disabled
                        defaultValue={parseFloat(formData.lastLogin)}
                        placeholder="Ordered"
                        ref={register({ required: "This field is required" })}
                      />
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        name="balance"
                        disabled
                        defaultValue={parseFloat(formData.list)}
                        placeholder="Ordered"
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.list && <span className="invalid">{errors.list.message}</span>}
                    </FormGroup>
                  </Col>
                  <Col md="6">
                    <FormGroup>
                      <label className="form-label">Oders</label>
                      <input
                        className="form-control"
                        type="number"
                        name="odd"
                        defaultValue={Number(formData.odd)}
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.odd && <span className="invalid">{errors.odd.message}</span>}
                    </FormGroup>
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        name="balance"
                        disabled
                        defaultValue={parseFloat(formData.attribute)}
                        placeholder="Ordered"
                        ref={register({ required: "This field is required" })}
                      />
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        name="balance"
                        disabled
                        defaultValue={parseFloat(formData.product)}
                        placeholder="Ordered"
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.balance && <span className="invalid">{errors.balance.message}</span>}
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        name="balance"
                        disabled
                        defaultValue={parseFloat(formData.listing)}
                        placeholder="Ordered"
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.balance && <span className="invalid">{errors.balance.message}</span>}
                  ...
                  <Col md="6">
                    <FormGroup>
                      ...
                      <input
                        ...
                        type="number"
                        name="odd"
                        defaultValue={Number(formData.order)}
                        ref={register({ required: "This field is required" })}
                      />
                      {errors.odd && <span className="invalid">{errors.odd.message}</span>}
                    </FormGroup>
