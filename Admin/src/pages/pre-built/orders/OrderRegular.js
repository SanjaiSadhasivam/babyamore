...
import { orderDatas, filterCoin, filterPaymentmethod, filterStatus, filterType } from "./OrderData";
import {
  Block,
  BlockHeadContent,
  BlockTitle,
...
const OrderRegular = () => {
  const [data, setData] = useState(orderDatas);
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = orderDatas.filter((item) => {
  ...
  return (
    <React.Fragment>
      <Head title="Cart List"></Head>
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle page>Cart List</BlockTitle>
            </BlockHeadContent>
            <BlockHeadContent>
            ...
            <div className="card-inner">
              <div className="card-title-group">
                <div className="card-title">
                  <h5 className="title">All Orders in Cart List</h5>
                </div>
              ...
              {currentItems.length > 0
                ? currentItems.map((item) => (
                  <DataTableItem key={item.id}>
                    ...
                    <DataTableRow size="sm">
                      <span className="tb-sub">{item.items}</span>
                    </DataTableRow>
                    <DataTableRow size="md">
