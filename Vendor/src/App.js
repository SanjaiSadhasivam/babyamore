...
const App = (props) => {
  return (
    <Switch>
      ...
      <Route exact path={`${process.env.PUBLIC_URL}/auth-register/:id`} component={Register}></Route>
      <Route exact path={`${process.env.PUBLIC_URL}/auth-login`} component={Login}></Route>
      <Route exact path={`${process.env.PUBLIC_URL}/auth-login/staff`} component={LoginStaff}></Route>
