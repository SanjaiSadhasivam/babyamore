...
const Logo = () => { 
  return (
    <Link to={`${process.env.PUBLIC_URL}/`} className="logo-link">
      ...
      <img className="logo-dark logo-img" src={BabyamoreLogo} alt="logo" style={{width:"160px"}}/>
      {/* <img className="logo-dark logo-img" src={BabyamoreLogo} alt="logo" style={{width:"150px"}} /> */}
