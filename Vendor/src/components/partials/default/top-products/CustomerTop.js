...
const CustomerTop = () => {
  ...
  const [dataSet, setDataSet] = useState( CustomerData);

  useEffect(() => {
    let object;
    if (data === "Daily") {
      object = customerDataSet2;
    } else if (data === "Monthly") {
      object =customerDataSet3;
    } else {
      object = customerDataSet4;
    }
    setDataSet(object);
  }, [data]);
      ...
      <div className="card-inner">
        <div className="card-title-group mb-2">
          <div className="card-title">
            <h6 className="title">Latest products</h6>
          </div>
