          ...
          <div className="container-fluid">
            ...
            <div className="row">
              ...
              <div className="col-md-5 d-flex mt-2">
                <div>
                  <span style={{ margin: "0", padding: "10px 0", width: "10%" }}>CANCELLATION STATUS</span>
                </div>
                <div className="">
                  ...
                  <select value={odstatus} className=" btn hoveffz d-md-inline" style={{ backgroundColor: "#fc8181", color: "#fff" }}
                    ...
                    <option className="dropdown_list" value="New orders">Refund</option>
                    <option className="dropdown_list" value="Preparing">Intransit</option>
                    <option className="dropdown_list" value="Ready to Handovereli"> Rejected</option>
