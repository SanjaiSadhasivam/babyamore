            ...
            <div className="accordion accordian-s2 mt-2">
              <div className="accordion-item ">
                <div
                  ...
                  onClick={toggle1}
                >
                  <p className="title" style={f13}><Icon name="user-add-fill"></Icon>CUSTOMER<Button size="sm" className="btn-dim" color="dark" style={{marginLeft:"65px"}}>View Profile</Button></p>
                ...
                >
                  <div className="accordion-inner">
                    <p>
                      <img src={User3} style={{ borderRadius: '50%', width: '10%', height: '10%' }}></img>&nbsp;
                      <span>Suresh</span>
                    </p>
                    <p className="text-muted">
                      Email: chad.rice@hotmail.com
                    </p>
                    <p className="text-muted">
                      Ph: 6359863236
                    </p>
                    <p className="text-muted">Customer IP:654896</p>
                    <div>
                      <div>
                        <fieldset>

                          <legend style={{fontSize:"1em",textAlign:"start"}} className="">SHIPPING ADDRESS</legend>

                          <p className="text-muted">183, Great Southern Trunk Rd, Arcot Rd, Vadapalani, Chennai, Tamil Nadu 600026, <span>Mobile: 9876543210.</span></p>
                          <p></p>
                        </fieldset>

                        <fieldset className="mt-2">
                          <legend style={{fontSize:"1em",textAlign:"start"}}className="">BILLING ADDRESS</legend>

                          <p className="text-muted">183, Great Southern Trunk Rd, Arcot Rd, Vadapalani, Chennai, Tamil Nadu 600026, <span>Mobile: 8765432109</span></p>
                    ...
                    <ul className="d-flex list-unstyled mt-2">
                      ...
                      <li><Button size="sm" className="btn-dim" color="dark" onClick={pdfDownload}>INVOICE</Button></li>
                    </ul>
                    <div
            ...
            <div className="accordion accordian-s2 mt-2">
              <div className="accordion-item ">
                <div
                  ...
                  onClick={toggle3}
                >
                  <p className="title" style={f13}> SHIPPING </p>
            ...
            <div className="accordion accordian-s2 mt-2">
              <div className="accordion-item ">
                <div
                  ...
                  onClick={toggle3}
                >
                  <p className="title" style={f13}> Return </p>
