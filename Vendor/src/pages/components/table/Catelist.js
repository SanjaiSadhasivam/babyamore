...
import { DisputesTableData102, DisputesTableDatamain, disputesTableColumnsadd2s,disputesTableColumnsmain, disputesTableColumns2s1, userData } from "./TablesData";
                   ...
                   <li className="nk-block-tools-opt">
                      <Button
                       ...
                       style={{width:'130px', top:'-73px'}} >
                        <Icon name="plus"></Icon><Link to='main-category' style={{color:'white'}}>Add Main Category</Link>
                      </Button>
                      <Button
                       ...
                       style={{width:'100%'}}>
                        ...
                        <Icon name="plus"></Icon>
                        <Link to='main-category' style={{color:'white'}}>
