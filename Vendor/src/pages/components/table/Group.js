...
import { DisputesTableData102Gro, disputesTableColumnsadd2sGro, disputesTableColumns2s1, userData } from "./TablesData";
    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          ...
          <PreviewCard>
            <ReactDataTable
              data={DisputesTableData102Gro}
              columns={disputesTableColumnsadd2sGro}
              expandableRows
              pagination
              actions
            />
                          ...
                          <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                            {({ getRootProps, getInputProps }) => (
                              <section>
                                ...
                                >
                                  <input {...getInputProps()} />
                                  {files1.length === 0 && <p>Background Image</p>}
                                  {files1.map((file) => (
                                    <div
                                      key={file.name}
                          ...
                          <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                            {({ getRootProps, getInputProps }) => (
                              <section>
                                ...
                                >
                                  <input {...getInputProps()} />
                                  {files1.length === 0 && <p>Cover Images </p>}
                                  {files1.map((file) => (
                                    <div
                                      key={file.name}
                                      className="dz-preview dz-processing dz-image-preview dz-error dz-complete"
                          ...
                          <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                            {({ getRootProps, getInputProps }) => (
                              <section>
                                ...
                                >
                                  <input {...getInputProps()} />
                                  {files1.length === 0 && <p>Icon Image</p>}
                                  {files1.map((file) => (
                                    <div
                                      key={file.name}
                                      className="dz-preview dz-processing dz-image-preview dz-error dz-complete"
