...
import { DisputesTableData102, disputesTableColumnsadd2s, disputesTableColumns2s1, userData } from "./TablesData";
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              ...
              <div className="toggle-wrap nk-block-tools-toggle" style={{marginTop:"60px"}}>
                <a
                  href="#more"
                ...
                <div
                  ...
                  style={{ display: smOption ? "block" : "none", justifyContent: "end" ,marginTop:"70px"}}
                >
