...
import { DisputesTableData102Gro21, disputesTableColumnsadd2sGro21, disputesTableColumns2s1, userData } from "./TablesData";
    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h4">CATEGORY GROUPS</BlockTitle>
              {/* <p>
          ...
          <PreviewCard>
            <ReactDataTable
              data={DisputesTableData102Gro21}
              columns={disputesTableColumnsadd2sGro21}
              expandableRows
              pagination
              actions
            />
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            ...
                            options={[
                              ...
                              { value: "MOTHER PRODUCT", label: "MOTHER PRODUCT" },
                          ...
                          <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                            {({ getRootProps, getInputProps }) => (
                              <section>
                                ...
                                >
                                  <input {...getInputProps()} />
                                  {files1.length === 0 && <p> Category Cover Image  </p>}
                                  {files1.map((file) => (
                                    <div
                                      key={file.name}
                          ...
                          <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                            {({ getRootProps, getInputProps }) => (
                              <section>
                                ...
                                >
                                  <input {...getInputProps()} />
                                  {files1.length === 0 && <p>Category Featured Image</p>}
                                  {files1.map((file) => (
                                    <div
                                      key={file.name}
                                      className="dz-preview dz-processing dz-image-preview dz-error dz-complete"
