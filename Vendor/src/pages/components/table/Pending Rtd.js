...
const PendingRTD = () => {
    ...
    const Getdata = async () => {
        ...
        const getd = Pendingrtd.data.list.filter((currEle) => currEle.vendor_id == cookies.vendor_id);
        console.log("pending rtd",getd)
        setPendingRtdData(getd);
    }
