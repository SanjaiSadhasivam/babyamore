...
import { DisputesTableData102,DisputesTableDatasub, disputesTableColumnsub, disputesTableColumnsadd2s,disputesTableColumnsmain, disputesTableColumns2s1, userData } from "./TablesData";
    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
                   ...
                   <li className="nk-block-tools-opt">
                      <Button
                       ...
                       style={{width:'130px', top:'-73px'}} >
                        <Icon name="plus"></Icon><Link to='sub-Category' style={{color:'white'}}>Add Sub Category</Link>
                      </Button>
                      <Button
                       ...
                       style={{width:'100%'}}>
                        ...
                        <Icon name="plus"></Icon>
                        <Link to='sub-Category' style={{color:'white'}}>
          ...
          <PreviewCard>
            <ReactDataTable
              data={DisputesTableDatasub}
              columns={disputesTableColumnsub}
              expandableRows
              pagination
              actions
            />
