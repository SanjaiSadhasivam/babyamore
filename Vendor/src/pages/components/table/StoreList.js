...
import { DisputesTableDatas,DisputesTableDatastore, disputesRate, DisputesTableDatastore2, disputesTableColpro, disputesTableColso2,  disputesTableColstore, DisputesTableData, disputesTableCol,disputesTableCol2, disputesTableColumns, disputesTableColumns2, userData, } from "./TableData";
    ...
    return(
        ...
        <Content page="component">
          ...
          <Block size="lg">
            ...
            <PreviewCard>
              <ReactDataTable data={DisputesTableDatastore} columns={disputesTableColstore} expandableRows pagination actions />
            </PreviewCard>
          </Block>
    ...
    return(
      ...
      <Content page="component">
        ...
        <Block size="lg">
          ...
          <PreviewCard>
            <ReactDataTable data={DisputesTableDatas} columns={disputesTableColpro} expandableRows pagination actions />
          </PreviewCard>
        </Block>
