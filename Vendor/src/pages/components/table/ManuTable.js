    ...
    <React.Fragment>
      ...
      <Content page="component">
        ...
        <Block size="lg">
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h4">Manufacturer</BlockTitle>
              {/* <p>
                       ...
                       COUNTRY* 
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="status"
                            options={[
                              { value: "CHINA", label: "Color" },
                              { value: "INDIA", label: "Format" },
                              { value: "AMERICA", label: "Gender" },
                              { value: "NEPAL", label: "Pattern" },
                      ...
                      <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                        {({ getRootProps, getInputProps }) => (
                          <section>
                            ...
                            >
                              <input {...getInputProps()} />
                              {files1.length === 0 && <p> Cover Image </p>}
                              {files1.map((file) => (
                                <div
                                  key={file.name}
                                  className="dz-preview dz-processing dz-image-preview dz-error dz-complete"
                      ...
                      <Dropzone onDrop={(acceptedFiles) => handleDropChange1(acceptedFiles)}>
                        {({ getRootProps, getInputProps }) => (
                          <section>
                            ...
                            >
                              <input {...getInputProps()} />
                              {files1.length === 0 && <p>Featured Image </p>}
                              {files1.map((file) => (
                                <div
                                  key={file.name}
                                  className="dz-preview dz-processing dz-image-preview dz-error dz-complete"
