...
import { bannerData, categoryOptions } from "./ProductData";
...
const BannersList = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = bannerData.filter((item) => {
          ...
          <ModalBody>
            ...
            <div className="nk-modal-head">
              <h4 className="nk-modal-title title">
                Banner <small className="text-primary">#{formData.sku}</small>
              </h4>
            ...
            <div className="nk-tnx-details mt-sm-3">
              <Row className="gy-3">
                <Col lg={6}>
                  <span className="sub-text">Banner Name & Details</span>
                  <span className="caption-text">{formData.name}</span>
                </Col>
                <Col lg={6}>
                  <span className="sub-text"> Banner Details </span>
                  <span className="caption-text"> {formData.price}</span>
                </Col>
                <Col lg={6}>
                  <span className="sub-text">Banner Category</span>
        ...
        >
          ...
          <BlockHead>
            <BlockHeadContent>
              ...
              <BlockDes>
                <p>Add Banners or update Banners.</p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
          <Block>
