...
import { announcementsData, categoryOptions } from "./ProductData";
...
const Announcements = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = announcementsData.filter((item) => {
      ...
      <Content>
                ...
                <div className="toggle-expand-content" style={{ display: sm ? "block" : "none" }}>
                  <ul className="nk-block-tools g-3">
                    ...
                    <li className="nk-block-tools-opt">
                      ...
                      <Button
                        className="toggle d-none d-md-inline-flex ser"
                        color="primary" 
                        onClick={() => {
                          toggle("");
                        }}
                              ...
                              <ul className="link-list-opt no-bdr">
                                ...
                                <li>
                                  ...
                                  >
                                    ...
                                    <span>Remove Announcements</span>
                                  </DropdownItem>
                                </li>
                                <li>
                ...
                <div className="card-inner">
                  {data.length > 0 ? (
                    ...
                    <div className="text-center">
                      <span className="text-silent">No Announcements found</span>
                    </div>
                  )}
                </div>
              </div>
        ...
        <Modal isOpen={view.edit} toggle={() => onFormCancel()} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Update Announcements</h5>
              <div className="mt-4">
          ...
          <ModalBody>
            ...
            <div className="nk-modal-head">
              <h4 className="nk-modal-title title">
                Announcements <small className="text-primary">#{formData.sku}</small>
              </h4>
            ...
            <div className="nk-tnx-details mt-sm-3">
              <Row className="gy-3">
                <Col lg={6}>
                  <span className="sub-text">Announcements Title</span>
        ...
        >
          ...
          <BlockHead>
            <BlockHeadContent>
              <BlockTitle tag="h5">Add Announcements </BlockTitle>
              <BlockDes>
                <p>Add announcements or update announcements.</p>
              </BlockDes>
            </BlockHeadContent>
          </BlockHead>
          <Block>
