...
const CouponSample = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = sampleData.filter((item) => {
  ...
  const onFormSubmit = (form) => {
    ...
    let submittedData = {
      ...
      sdate: getDateStructured(formData.date),
      edate: getDateStructured(formData.date),
    //   purchased: purchased,
    //   paid: formData.paid,
      check: false,
    };
                    ...
                    <Col md="12">
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          ...
                          />
                          {errors.customer && <span className="invalid">{errors.type.message}</span>}
                        </div>
                      </div>
                    </Col>
                    {/* <Col md="6">
                    ...
                    <Col md="6">
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          ...
                          />
                          {errors.total && <span className="invalid">{errors.discount.message}</span>}
                        </div>
                      </div>
                    </Col>
                    <Col md="6">
