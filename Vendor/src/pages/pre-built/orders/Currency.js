...
import { currencyData } from "./OrderData";
import {
  Block,
  BlockHeadContent,
  BlockTitle,
...
const Currency = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = currencyData.filter((item) => {
    ...
    <React.Fragment>
      ...
      <Content>
        <BlockHead size="sm">
          <BlockBetween>
            <BlockHeadContent>
              <BlockTitle> Currency </BlockTitle>
            </BlockHeadContent>
            <BlockHeadContent>
        ...
        <Block>
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow size="md">
                <span className="sub-text">Symbol</span>
              </DataTableRow>
              <DataTableRow>
                <span className="sub-text">Subunit</span>
              </DataTableRow>
             
              <DataTableRow size="md">
                <span className="sub-text">Decimal Mark</span>
              </DataTableRow>
              
              <DataTableRow>
                <span className="sub-text">Thousand Separator</span>
              </DataTableRow>
            ...
            {currentItems.length > 0
              ? currentItems.map((item) => (
                  <DataTableItem key={item.id}>
                    ...
                    <DataTableRow size="sm">
                      <span className="tb-sub">{item.symbol}</span>
                    </DataTableRow>
                    {/* <DataTableRow>
                      <span
                    ...
                    <DataTableRow size="sm">
                      <span className="tb-sub">{item.subunits}</span>
                    </DataTableRow>
                    {/* <DataTableRow>
                      <span
          ...
          <PreviewAltCard>
            {data.length > 0 ? (
              ...
              <div className="text-center">
                <span className="text-silent">No Currency found</span>
              </div>
            )}
          </PreviewAltCard>
        </Block>
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="status"
                            options={[
                              { value: "On Holdfffd", label:  "," },
                              { value: "Delivered", label: " . " },
                              { value: "Delivered", label: " Space() " },
                            ]}
          ...
          <ModalBody>
            ...
            <div className="nk-tnx-details mt-sm-3">
              <div className="nk-modal-head mb-3">
                <h5 className="title">Currency Details</h5>
              </div>
              <Row className="gy-3">
                {/* <Col lg={6}>
                ...
                <Col lg={6}>
                  <span className="sub-text"> Symbol </span>
                  <span className="caption-text">{formData.symbol}</span>
                </Col>
                <Col lg={6}>
                  <span className="sub-text">Subunit</span>
                  <span className="caption-text">{formData.subunits}</span>
                </Col>
                <Col lg={6}>
                  <span className="sub-text">Decimal Mark</span>
