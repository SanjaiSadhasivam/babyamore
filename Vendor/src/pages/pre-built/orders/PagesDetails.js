...
import { pagesData } from "./OrderData";
import {
  Block,
  BlockHeadContent,
  BlockTitle,
...
import { UncontrolledDropdown, DropdownMenu, DropdownToggle, DropdownItem, Button, Modal, ModalBody, FormGroup } from "reactstrap";
...
const PageDetails = () => {
  ...
  useEffect(() => {
    if (onSearchText !== "") {
      const filteredObject = pagesData.filter((item) => {
      ...
      <Content>
          ...
          <div className="nk-tb-list is-separate is-medium mb-3">
            <DataTableHead className="nk-tb-item">
              ...
              <DataTableRow size="sm">
                <span className="sub-text">Page Title</span>
              </DataTableRow>
              <DataTableRow size="md">
                <span className="sub-text">Visbility</span>
              </DataTableRow>
              <DataTableRow>
                <span className="sub-text"> View Position </span>
              </DataTableRow>
             
              <DataTableRow size="md">
                <span className="sub-text"> Authors</span>
              </DataTableRow>
              
              <DataTableRow>
                <span className="sub-text">Page Vistors</span>
              </DataTableRow>
        ...
        <Modal isOpen={view.add} toggle={() => onFormCancel()} className="modal-dialog-centered" size="lg">
          <ModalBody>
            ...
            <div className="p-2">
              <h5 className="title">Add Pages</h5>
              <div className="mt-4">
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="paid"
                            options={[
                              { value: "Due", label: "MAIN NAVBAR" },
                              { value: "Paid", label: "COPY RIGHTS" },
                              { value: "Cancelled", label: "FOOTERS " },
                            ]}
                      ...
                      <div className="form-group">
                        ...
                        <div className="form-control-wrap">
                          <RSelect
                            name="paid"
                            options={[
                              { value: "Due", label: "PUBLIC" },
                              { value: "Paid", label: "MERCHANT" },
