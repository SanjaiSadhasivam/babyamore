...
const Login = () => {
  ...
  const Submit = (event) => {
    ...
    try {
      axios.post(UsersLogin, formData, config).then((res) => {
        ...
        if (res.data.statusCode == 200) {
          ...
          localStorage.setItem("staff_id", res.data.data.staff_id)
          // localStorage.setItem("staffVendor_id", res.data.data.vendor_id)
          // setCookie('accesstoken', Auth)

          setTimeout(() => {
            // setCookie("accesstoken", res.data.token);
            // setCookie("staff_id", res.data.data.staff_id);
      ...
      <PageContainer>
        <Block className="nk-block-middle nk-auth-body  wide-xs">
          ...
          <PreviewCard className="card-bordered" bodyClass="card-inner-lg">
            <BlockHead>
              {/* <h3 style={{textAlign:"center",color:"red"}}>VENDOR'S STAFF</h3> */}
              <BlockContent>
